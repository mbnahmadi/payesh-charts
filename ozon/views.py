...
file_path_ozon = "ozon/data/Ozone_daily_Apr 2025.csv"
def ozon_view(request):
    data = read_ozon(file_path_ozon)
    return render(request, 'ozon/ozon.html', {'data': data})


file_path_radiation = "ozon/data/radiation/2025-05/27-5-2025.csv"
file_path_vis = "ozon/data/visibility/may2025/visibility and present weather27May2025 00.00.xlsx"
